(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('angular-cesium', ['exports', '@angular/core', '@angular/common', 'geodesy', 'util', 'rxjs/operators', 'rxjs', 'primitive-primitives', 'json-string-mapper', 'angular2parse', 'lodash.get', 'heatmap.js/build/heatmap.js'], factory) :
    (global = global || self, factory(global['angular-cesium'] = {}, global.ng.core, global.ng.common, global.geodesy, global.util, global.rxjs.operators, global.rxjs, global.primitivePrimitives, global.jsonStringMapper, global.angular2parse, global._get, global.h337));
}(this, function (exports, core, common, geodesy, util, operators, rxjs, primitivePrimitives, jsonStringMapper, angular2parse, _get, h337) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var AcContextMenuWrapperComponent = /** @class */ (function () {
        ...
        AcContextMenuWrapperComponent.propDecorators = {
            viewContainerRef: [{ type: core.ViewChild, args: ['contextMenuContainer', { static: false, read: core.ViewContainerRef },] }]
        };
    ...
    var PolygonsEditorComponent = /** @class */ (function () {
        ...
        PolygonsEditorComponent.propDecorators = {
            editPolygonsLayer: [{ type: core.ViewChild, args: ['editPolygonsLayer', { static: false },] }],
            editPointsLayer: [{ type: core.ViewChild, args: ['editPointsLayer', { static: false },] }],
            editPolylinesLayer: [{ type: core.ViewChild, args: ['editPolylinesLayer', { static: false },] }]
        };
    ...
    var CirclesEditorComponent = /** @class */ (function () {
        ...
        CirclesEditorComponent.propDecorators = {
            editCirclesLayer: [{ type: core.ViewChild, args: ['editCirclesLayer', { static: false },] }],
            editArcsLayer: [{ type: core.ViewChild, args: ['editArcsLayer', { static: false },] }],
            editPointsLayer: [{ type: core.ViewChild, args: ['editPointsLayer', { static: false },] }]
        };
    ...
    var EllipsesEditorComponent = /** @class */ (function () {
        ...
        EllipsesEditorComponent.propDecorators = {
            editEllipsesLayer: [{ type: core.ViewChild, args: ['editEllipsesLayer', { static: false },] }],
            editPointsLayer: [{ type: core.ViewChild, args: ['editPointsLayer', { static: false },] }]
        };
    ...
    var PolylinesEditorComponent = /** @class */ (function () {
        ...
        PolylinesEditorComponent.propDecorators = {
            editPointsLayer: [{ type: core.ViewChild, args: ['editPointsLayer', { static: false },] }],
            editPolylinesLayer: [{ type: core.ViewChild, args: ['editPolylinesLayer', { static: false },] }],
            polylineLabelsLayer: [{ type: core.ViewChild, args: ['polylineLabelsLayer', { static: false },] }]
        };
    ...
    var HippodromeEditorComponent = /** @class */ (function () {
        ...
        HippodromeEditorComponent.propDecorators = {
            editPointsLayer: [{ type: core.ViewChild, args: ['editPointsLayer', { static: false },] }],
            editHippodromesLayer: [{ type: core.ViewChild, args: ['editHippodromesLayer', { static: false },] }]
        };
